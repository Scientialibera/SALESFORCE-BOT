"""
Salesforce MCP Server using the official MCP library.

This implements an MCP server with SQL and Graph query tools,
including account resolution logic from the original chatbot.
"""
...
async def call_tool(name: str, arguments: Dict[str, Any]) -> List[TextContent]:
    ...
    try:
        ...
        accounts_mentioned = arguments.get("accounts_mentioned", [])
